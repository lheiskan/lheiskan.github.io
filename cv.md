...
Role: Co-founder, CTO  
Description: Co-founded a web analytics startup building a privacy friendly, easy to use, web analytics product. Company collected one VC seed round. It released a demo product to some 300 customers, but run out of funding and was resolved in the end of 2023. Designed and built the data ingestion and analytics stack for the production, along with deployment, hosting and monitoring tooling for the backend platform.  
